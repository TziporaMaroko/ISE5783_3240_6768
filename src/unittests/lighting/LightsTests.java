...
public class LightsTests {
	...
	public void trianglesAll() {
		scene2.geometries.add(triangle1, triangle2);
		scene2.lights.add(new SpotLight(new Color(BLUE), new Point(10, 30, -50), trianglesLightDirection)
				.setKL(0.001).setKQ(0.0001));
		scene2.lights.add(new PointLight(trianglesLightColor, trianglesLightPosition).setKL(0.001).setKQ(0.0002));
		scene2.lights.add(new DirectionalLight(new Color(RED), trianglesLightDirection));
	...
	public void sphereAll() {
		scene1.geometries.add(sphere);
		scene1.lights.add(new SpotLight(new Color(RED), new Point(-10, -20, 20), new Vector(1, 1, -0.5)).setKL(0.001)
				.setKQ(0.0001));
		scene1.lights.add(new DirectionalLight(new Color(WHITE), new Vector(1, 1, -0.5)));
		scene1.lights.add(new PointLight(new Color(BLUE), sphereLightPosition).setKL(0.001).setKQ(0.0002));
